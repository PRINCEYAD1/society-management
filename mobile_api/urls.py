...
urlpatterns = [
    ...
    path("move-requests/", MoveRequestListCreateView.as_view(), name="move_request_list_create"),
    path("move-requests/<int:pk>/", MoveRequestDetailView.as_view(), name="move_request_detail"),
    path("domestic-workers/", DomesticWorkerListCreateView.as_view(), name="domestic_worker_list_create"),
    path("domestic-workers/<int:pk>/", DomesticWorkerDetailView.as_view(), name="domestic_worker_detail"),
    path("domestic-workers/attendance/", StaffAttendanceListCreateView.as_view(), name="staff_attendance_list_create"),
    path("domestic-workers/attendance/<int:pk>/", StaffAttendanceDetailView.as_view(), name="staff_attendance_detail"),
    path("certificate-requests/", CertificateRequestListCreateView.as_view(), name="certificate_request_list_create"),
    path("certificate-requests/<int:pk>/", CertificateRequestDetailView.as_view(), name="certificate_request_detail"),
    path("events/", SocietyEventListCreateView.as_view(), name="society_event_list_create"),
    path("events/<int:pk>/", SocietyEventDetailView.as_view(), name="society_event_detail"),
    path("meetings/", SocietyMeetingListCreateView.as_view(), name="society_meeting_list_create"),
    path("meetings/<int:pk>/", SocietyMeetingDetailView.as_view(), name="society_meeting_detail"),
    path("assets/", SocietyAssetListCreateView.as_view(), name="society_asset_list_create"),
    path("assets/<int:pk>/", SocietyAssetDetailView.as_view(), name="society_asset_detail"),
    path("vendor-amc/", VendorAMCListCreateView.as_view(), name="vendor_amc_list_create"),
    path("vendor-amc/<int:pk>/", VendorAMCDetailView.as_view(), name="vendor_amc_detail"),
